#Importacion de servicio y aplicativos
import config
...
#Conexion de cliente a Binance por API
...
while 1:
    ...
    try:
        ...
        with open("BTCUSDT_scalper.txt", "a") as myfile:
    ...
    if ( symbolPrice < ma50*0.99 ):
        ...
        try:
            ...
            buyOrder = client.create_order(
                        ...
                        quantity=10,
                        price='{:.8f}'.format(round(symbolPrice*39000,8)),
                        stopPrice='{:.8f}'.format(round(symbolPrice*38998,8)),
                        timeInForce='GTC')
            ...
            orderOCO = client.order_oco_sell(
                        symbol = symbolTicker,
                        quantity = 10,
                        price = '{:.8f}'.format(round(float(symbolPrice)*38000)),
                        stopPrice = '{:.8f}'.format(round(float(symbolPrice)*37000)),
                        stopLimitPrice = '{:.8f}'.format(round(float(symbolPrice)*36998,8)),
